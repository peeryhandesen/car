...
public class BottomBarTab extends FrameLayout {
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.custom_bottom_press));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.custom_bottom_press));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.custom_bottom_no_press));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.custom_bottom_no_press));
        }
    }
